function Bullet(pos, dir, type, owner, customType) {
    this.info = type;
    this.customType = customType || type;
    this.pos = pos.copy(); // pos is a vector
    this.vel = dir;
    this.o = owner;
    this.born = mil;

    this.col = this.customType.color || [random(255), random(255), random(255)];
...
Bullet.prototype.run = function() {
    ...
    if ((mil - this.born) / 1000 > this.customType.life) {
        this.end();
    }
};
...
Bullet.prototype.show = function() {
    ...
    ellipse(this.pos.x, this.pos.y, this.customType.radius * 2);
};